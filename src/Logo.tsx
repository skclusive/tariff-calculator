...
import { Breakpoint, SvgIcon, Theme } from "@suid/material";

export function Logo(props: { sx?: SxProps<Theme<Breakpoint>> }) {
  return (
    <SvgIcon viewBox="0 0 472.000000 444.000000" sx={props.sx}>
      <g
